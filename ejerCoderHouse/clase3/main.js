...
de un algoritmo en JavaScript que emplee bucles e instrucciones condicionales.
...
Mientras que usamos while cuando queremos repetir algo hasta que se deje de cumplir una condición.

Ejemplo

-   Pedir número mediante prompt y sumarle otro número en cada 
    repetición,realizando una salida por cada resultado
-   Pedir un texto mediante prompt, concatenar un valor en cada 
